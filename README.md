...
### Resultados de todos los modelos entrenados
...
|                          |   n_images |   img_size |   batch_size |   validation_freq |   num_epochs | layer1                 | layer2                      | layer3       | callbacks                                 |   train_acc |   train_loss |   val_acc |   val_loss |
|:-------------------------|-----------:|-----------:|-------------:|------------------:|-------------:|:-----------------------|:----------------------------|:-------------|:------------------------------------------|------------:|-------------:|----------:|-----------:|
| model_prototype_v1.h5    |       1000 |        224 |           32 |                 1 |           10 | None                   | None                        | None         | None                                      |      100    |         4    |     66.5  |        128 |
| model_prototype_v2.h5    |       3000 |        224 |           64 |                 1 |           10 | None                   | None                        | None         | None                                      |       99.96 |         5    |     78.17 |         75 |
| model_prototype_v3.keras |       1000 |        224 |           32 |                 1 |           10 | Flatten                | Dense(512, relu)            | Dropout(0.1) | None                                      |       99.12 |         3    |     35.5  |        384 |
| model_prototype_v4.keras |       1000 |        224 |           32 |                 1 |           10 | Flatten                | None                        | None         | None                                      |      100    |         0    |     37    |       1463 |
| model_prototype_v5.keras |       1000 |        224 |           32 |                 1 |           10 | GlobalAveragePooling2D | Dense(512, relu)            | Dropout(0.3) | None                                      |      100    |         4    |     63    |        136 |
| model_prototype_v6.keras |       1000 |        224 |           32 |                 1 |           10 | GlobalAveragePooling2D | Dense(512, relu, L2(0.001)) | Dropout(0.3) | None                                      |       99.75 |        64    |     61.5  |        195 |
| model_prototype_v7.keras |       1000 |        224 |           32 |                 1 |           10 | GlobalAveragePooling2D | Dense(512, relu, L2(0.01))  | Dropout(0.3) | None                                      |       98.5  |       117    |     59.5  |        248 |
| model_v1                 |      10222 |        224 |           32 |                 1 |           25 | GlobalAveragePooling2D | Dense(512, relu, L2(0.01))  | Dropout(0.3) | None                                      |       75.25 |       141    |     68.61 |        170 |
| model_v2                 |      10222 |        224 |           32 |                 5 |           25 | GlobalAveragePooling2D | Dense(512, relu, L2(0.001)) | Dropout(0.1) | None                                      |       93.54 |        55    |     70.51 |        158 |
| model_v3                 |      10222 |        224 |           32 |                 1 |           50 | GlobalAveragePooling2D | Dense(512, relu, L2(0.01))  | Dropout(0.2) | None                                      |       79.03 |       119    |     70.86 |        158 |
| model_v4                 |      10222 |        224 |           32 |                 1 |          100 | GlobalAveragePooling2D | Dense(512, relu, L2(0.01))  | Dropout(0.2) | None                                      |       82.63 |       104    |     72.13 |        152 |
| model_v5.keras           |      10222 |        224 |           96 |                 1 |          100 | GlobalAveragePooling2D | Dense(512, relu, L2(0.005)) | Dropout(0.1) | EarlyStopping(monitor=loss, p=5)          |       87.89 |        80    |     72.86 |        132 |
| model_v6.keras           |      10222 |        224 |           96 |                 1 |          100 | GlobalAveragePooling2D | Dense(512, relu, L2(0.005)) | Dropout(0.1) | EarlyStopping(monitor=val_accuracy, p=5)  |       88.27 |        78.92 |     71.93 |        131 |
| model_v7.keras           |      10222 |        224 |           96 |                 1 |           50 | GlobalAveragePooling2D | Dense(512, relu, L2(0.001)) | Dropout(0.1) | EarlyStopping(monitor=val_accuracy, p=10) |       96.6  |        39    |     75.89 |        118 |
